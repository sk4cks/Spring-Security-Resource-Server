...
public class JwtDecoderConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "spring.security.oauth2.resourceserver.jwt", name = "jwsAlgorithms", havingValue = "HS256", matchIfMissing = false)
    ...
    @Bean
    @ConditionalOnProperty(prefix = "spring.security.oauth2.resourceserver.jwt", name = "jwsAlgorithms", havingValue = "RS512", matchIfMissing = false)
